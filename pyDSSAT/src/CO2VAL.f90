...
!     Switch ICO2:
!     ICO2 = 'D'  use static value (CO2BAS from CO2045.WDA)
!     ICO2 = 'W'  use values read from weather file
!     ICO2 = 'M'  use monthly values read from CO2045.WDA file 
!                  (default)
...
!=======================================================================
      ...
      SUBROUTINE CO2VAL(CONTROL, ISWITCH, CCO2, CO2)
!-----------------------------------------------------------------------
      USE ModuleDefs   
      IMPLICIT NONE
      SAVE
