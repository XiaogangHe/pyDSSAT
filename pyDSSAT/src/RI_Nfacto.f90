...
C=======================================================================
      ...
      SUBROUTINE RI_NFACTO(DYNAMIC, FIELD, XSTAGE,              !Input
...
!  03/03/2007 US - Put these in species file.
     ...
     &          5.00,5.20,5.50,6.00,7.50,9.0/
      ...
      DATA NPER/4.40,4.20,4.10,3.90,3.41,3.00,2.90,2.50,2.30,1.85,
     &          1.45,1.05,0.80,0.65,0.50,0.45/
