...
C-----------------------------------------------------------------------
      DO L = 1, NLAYR
         ...
         RNO3U(L) = RFAC * FNO3 * 0.0055
         RNH4U(L) = RFAC * FNH4 * 0.0055
      ...
      IF (FLOOD .GT. 0.0 .AND. RLV(1) .GT. 1.0) THEN
         ...
         FRNO3U = RFAC * FNO3*0.0055
         FRNH4U = RFAC * FNH4*0.0055
