!=======================================================================
!  ML_OPHARV, Subroutine C.H. Porter
!  Generates data for use by OPSUM and OVERVIEW for MILLET
!-----------------------------------------------------------------------
!  REVISION HISTORY
