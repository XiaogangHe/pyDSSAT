...
!
!  Purpose: This subroutine reads the input data from the SOMFX045.SDA
!           file.
!
!  Revision history:
...
!     ------------------------------------------------------------------
      ...
      CHARACTER*80 PATHSD
      CHARACTER*92 SOMPF
      CHARACTER*12, PARAMETER :: SOMFILE = 'SOMFX045.SDA'
...
!      CHARACTER*6  ROUTIN
      ...
      CHARACTER*13, PARAMETER :: SOMFILE = 'SOMFX045.SDA'
      CHARACTER*78  MSG(4)
      INTEGER ERRNUM, LNUM
      INTEGER LEN
